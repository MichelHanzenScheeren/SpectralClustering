...
class Distance:
  """ Classe que encapsula a lógica de cálculo das distâncias.
  Os métodos usam auxiliares do python (como max - retorna o valor mais alto da lista, ou sum - soma todos os valores da lista).
